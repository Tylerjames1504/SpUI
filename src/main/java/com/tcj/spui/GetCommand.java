  ...
  public static void execute(String user) {
    ...
    switch (user.toLowerCase().trim()) {
      ...
      case "getartiststoptracks" -> {
        ...
        System.out.println(ansi().render("@|green Enter name you want to search|@"));
        MainHELLO.name = input.nextLine();
        GetArtistsTopTracks top = new GetArtistsTopTracks(MainHELLO.spotifyApi, MainHELLO.name,
            MainHELLO.location);
        System.out.println();
        top.execute();
        System.out.println();
      ...
      case "getmytopartists" -> {
        ...
        System.out.println(ansi().render(
            "@|green Would you like to create a playlist filled with above artists? |@@|yellow (y or n)|@"));
        user = input.next();
        if (user.equalsIgnoreCase("y")) {
          ...
          MainHELLO.name = input.nextLine();
          System.out.println(ansi().render(
              "@|green Would you like the playlist to be public? |@@|yellow (y or n)|@"));
          MainHELLO.playlistPublic = (input.nextLine().equalsIgnoreCase("y"));
          System.out.println(ansi().render(
              "@|green How many artists (randomized) should be included in the playlist?|@"));
      ...
      case "getmytoptracks" -> {
        ...
        System.out.println();
        System.out.println(ansi().render(
            "@|green Would you like to add the songs into a playlist? |@@|yellow (y or n)|@"));
      ...
      case "createcategoryplaylist" -> {
        ...
        System.out.println(
            ansi().render("@|green Genre preference (in case there are duplicates):|@"));
        MainHELLO.genre = input.nextLine();
        System.out.println(ansi().render("@|green Name of the playlist:|@"));
        MainHELLO.name = input.nextLine();
        System.out.println(ansi().render(
        ...
        MainHELLO.playlistPublic = (input.nextLine().equalsIgnoreCase("y"));
        System.out.println(ansi().render(
            "@|green How many playlists to search?|@ @|yellow (Total # of songs = [# of playlists] X [# of songs per playlist])|@"));
        MainHELLO.numPlaylists = input.nextInt();
        System.out.println(ansi().render(
            "@|green How many songs per playlist?|@ @|yellow (Total # of songs = [# of playlists] X [# of songs per playlist])|@"));
        MainHELLO.limit = input.nextInt();
        System.out.println();
      ...
      case "remixplaylists" -> {
        AuthorizationCodeRefresh.authorizationCodeRefresh();
        System.out.println(ansi().render(
            "@|green Genre preference|@ @|yellow (This is for in case there are duplicates. Press enter to skip):|@"));
        MainHELLO.genre = input.nextLine();
        System.out.println(ansi().render("@|green Name of the playlist:|@"));
        MainHELLO.name = input.nextLine();
        System.out.println(ansi().render(
        ...
        MainHELLO.numPlaylists = input.nextInt();
        System.out.println(ansi().render(
            "@|green How many songs per playlist|@ @|yellow [Max: 100]|@@|green ?|@ @|yellow (Total # of songs = [# of playlists] X [# of songs per playlists])|@"));
        MainHELLO.limit = input.nextInt();
        System.out.println();
      ...
      default -> {
        ...
        if (!user.equalsIgnoreCase("q")) {
          System.out.println(ansi().render("@|red Command: |@" + user
