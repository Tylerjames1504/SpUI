...
public class HomePageController {
  ...
  private String[] topArtistPieces = {"artistHover", "topArtistInfo", "topArtistPopu",
      "topArtistImage"};
  private int[] topArtistPiecesSizes = {10, 10, 10, 10};
  // per element hover functionality features top Artists
  private String[] topArtistPiecesMax = {"artistHover", "topArtistInfo", "topArtistPopu",
  ...
  private String[] topSongPiecesMax = {"songHover", "topSongInfo", "topSongPopu", "topSongImage",
      "changeSongs"};
  ...
  public void onClickExpandable(MouseEvent event) {
    ...
    int index = Integer.parseInt(
        sourceInfo[1].substring(sourceInfo[1].length() - 1, sourceInfo[1].length()));
